  ...
  const allDisplayRows = useMemo(() => {
    ...
    for (const pt of projectedTxs ?? []) {
      rows.push({
        ...
        groupName: null,
        isIgnored: false,
        // The fork's installment projections carry their parcel numbers, so
        // the k/N badge upstream added renders for them too instead of the
        // generic projected badge alone.
        installmentNumber: pt.installment_number ?? null,
        totalInstallments: pt.total_installments ?? null,
